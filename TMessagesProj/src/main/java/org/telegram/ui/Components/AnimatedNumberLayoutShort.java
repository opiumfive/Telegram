...
public class AnimatedNumberLayoutShort {
    ...
    public static final Property<AnimatedNumberLayoutShort, Float> PROGRESS = new AnimationProperties.FloatProperty<AnimatedNumberLayoutShort>("progress") {
        @Override
        public void setValue(AnimatedNumberLayoutShort object, float value) {
            object.setProgress(value);
        }

        @Override
        public Float get(AnimatedNumberLayoutShort object) {
            return object.progress;
        }
    };

    public AnimatedNumberLayoutShort(View parent, TextPaint paint) {
        textPaint = paint;
        parentView = parent;
    }
    ...
    public void setNumber(int number, boolean animated) {
        ...
        letters.clear();
        String oldText = LocaleController.formatShortNumber(currentNumber, null);
        String text = LocaleController.formatShortNumber(number, null);
